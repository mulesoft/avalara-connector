...
public class BatchTypeEnumTransformer
    ...
    implements DiscoverableTransformer
{
    ...
    public BatchTypeEnumTransformer() {
        registerSourceType(DataTypeFactory.create(String.class));
        setReturnClass(BatchType.class);
        setName("BatchTypeEnumTransformer");
    }
        ...
        throws TransformerException
    {
        ...
        result = Enum.valueOf(BatchType.class, ((String) src));
        return result;
    }
