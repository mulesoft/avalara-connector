...
/**
 * IsBatchFinishedMessageProcessor invokes the {@link org.mule.modules.avalara.AvalaraModule#isBatchFinished(java.lang.String)} method in {@link AvalaraModule }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.5.3", date = "2015-11-11T05:00:21-03:00", comments = "Build UNNAMED.2049.ec39f2b")
public class IsBatchFinishedMessageProcessor
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public IsBatchFinishedMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedBatchId = ((String) evaluateAndTransform(getMuleContext(), event, IsBatchFinishedMessageProcessor.class.getDeclaredField("_batchIdType").getGenericType(), null, batchId));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((AvalaraModule) object).isBatchFinished(_transformedBatchId);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at AvalaraModule at isBatchFinished retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
