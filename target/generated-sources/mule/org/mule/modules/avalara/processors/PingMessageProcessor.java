...
/**
 * PingMessageProcessor invokes the {@link org.mule.modules.avalara.AvalaraModule#ping(java.lang.String)} method in {@link AvalaraModule }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public PingMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedMessage = ((String) evaluateAndTransform(getMuleContext(), event, PingMessageProcessor.class.getDeclaredField("_messageType").getGenericType(), null, message));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((AvalaraModule) object).ping(_transformedMessage);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at AvalaraModule at ping retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
