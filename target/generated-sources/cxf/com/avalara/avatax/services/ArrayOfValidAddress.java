...
/**
 * <p>Java class for ArrayOfValidAddress complex type.
 * 
...
@XmlType(name = "ArrayOfValidAddress", propOrder = {
    "validAddress"
})
public class ArrayOfValidAddress {

    @XmlElement(name = "ValidAddress", nillable = true)
     ...
     * This is why there is not a <CODE>set</CODE> method for the validAddress property.
     * 
     * <p>
    ...
    public List<ValidAddress> getValidAddress() {
        if (validAddress == null) {
            validAddress = new ArrayList<ValidAddress>();
        }
